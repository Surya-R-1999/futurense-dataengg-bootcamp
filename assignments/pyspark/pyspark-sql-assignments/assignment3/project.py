...
data  = spark.read.load("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/bankmarketdata.csv",format = "csv", sep = ";", delimiter=';',header=True,inferSchema=True)
...
result1.write.mode('overwrite').format('parquet').save("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_age")

result2.write.mode('overwrite').format('parquet').save("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_marital_status")

result3.write.mode('overwrite').format('parquet').save("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_age_and_marital_status")
...
spark_df.write.mode('overwrite').format('parquet').save('/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/analysis')



resultant_data1  = spark.read.load("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_age",format = "parquet",header=True,inferSchema=True)

resultant_data2  = spark.read.load("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_marital_status",format = "parquet",header=True,inferSchema=True)

resultant_data3  = spark.read.load("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/impact_of_age_and_marital_status",format = "parquet",header=True,inferSchema=True)

resultant_data4  = spark.read.load("/mnt/c/Users/miles/Documents/futurense-dataengg-bootcamp/PySpark/DataFrame/Case Study/End To End Project Banking Marketing Analysis/Results/analysis",format = "parquet",header=True,inferSchema=True)
